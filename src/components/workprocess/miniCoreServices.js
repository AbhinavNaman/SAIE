...
export default function MiniCoreServices() {
  ...
  const cards = [
    ...
    },
    {
      ...
      description:
        "Our robust Data Foundation services ensure the integrity and security of your data assets. With comprehensive governance, quality control, integration, metadata management, and data modeling, we lay the groundwork for a data-driven organization.",
    },
    {
      ...
      description:
        "Leverage our Smart AI Platform as a pivotal transformation tool. Whether on-premise or on the cloud, our platform is designed to scale with your business, delivering AI-driven solutions that propel growth and innovation.",
    },
  ];
                  ...
                  >
                    ...
                    >
                      <div className="card-body mini-cre-service-card text-center p-4 p-xxl-5 d-flex flex-column align-items-center justify-content-center">
                        {card.icon}
                        <h4 className="mb-4 text-primary">{card.title}</h4>
