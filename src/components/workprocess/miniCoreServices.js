        ...
        <div className="row gy-4 gy-md-5 gy-lg-0 align-items-center">
          <div className="col-12 col-lg-3">
            ...
            <div className="row">
              <div className="col-12 col-xl-11">
                {/* <h4 className="mb-3 mb-xl-4">comprehensive services</h4> */}
          ...
          <div className="col-12 col-lg-9 overflow-hidden">
            ...
            <div className="row gy-4">
              <Link href="/core-services#responsible-ai">
                <div className="col-12 col-sm-6">
                  <div className="card bg-dark-shade border-0 border-bottom border-primary shadow-sm">
                    <div className="card-body mini-cre-service-card text-center p-4 p-xxl-5 d-flex flex-column align-items-center justify-content-center">
                      ...
                      <h4 className="mb-4 text-primary">Responsible AI</h4>
                      <p className="mb-4">
                        We craft AI solutions with a conscience. Our Responsible
                        AI framework ensures ethical, transparent, and
                        accountable AI deployment, aligning with societal values
              ...
              <Link href="/core-services#visualization-and-user-experience">
                <div className="col-12 col-sm-6">
                  <div className="card bg-dark-shade border-0 border-bottom border-primary shadow-sm">
                    <div className="card-body mini-cre-service-card text-center p-4 p-xxl-5 d-flex flex-column align-items-center justify-content-center">
                      <svg
                      ...
                      <p className="mb-4">
                        Transform data into compelling stories through our
                        advanced visualization services. From intuitive
                        dashboards to interactive chatbots and seamless mobile
                        apps, we enhance the user experience at every
                        touchpoint.
                      </p>
                    </div>
                  </div>
              ...
              <Link href="/core-services#data-foundation">
                <div className="col-12 col-sm-6">
                  <div className="card bg-dark-shade border-0 border-bottom border-primary shadow-sm">
                    <div className="card-body mini-cre-service-card text-center p-4 p-xxl-5 d-flex flex-column align-items-center justify-content-center">
                      <svg
                      ...
                      <h4 className="mb-4 text-primary">Data Foundation</h4>
                      <p className="mb-4">
                        Our robust Data Foundation services ensure the integrity
                        and security of your data assets. With comprehensive
                        governance, quality control, integration, metadata
                        management, and data modeling, we lay the groundwork for
              ...
              <Link href="/core-services#smart-ai-platform">
                <div className="col-12 col-sm-6">
                  <div className="card bg-dark-shade border-0 border-bottom border-primary shadow-sm">
                    <div className="card-body mini-cre-service-card text-center p-4 p-xxl-5 d-flex flex-column align-items-center justify-content-center">
                      <svg
                      ...
                      <h4 className="mb-4 text-primary">Smart AI Platform</h4>
                      <p className="mb-4">
                        Leverage our Smart AI Platform as a pivotal
                        transformation tool. Whether on-premise or on the cloud,
                        our platform is designed to scale with your business,
                        delivering AI-driven solutions that propel growth and
                        innovation.
                      </p>
                    </div>
                  </div>
